...
<table>
    ...
    <tr>
        <td>002.</td>
        <td>Database</td>
        <td rowspan=2><b>Database</b><br/>AWS RDS<br/><br/><b>Storage</b><br/>자체 Storage</td>
    ...
    <tr>
        <td>004.</td>
        <td>Server / API</td>
        <td><b>Security, Identity, & Compliance</b><br/>AWS IAM<br/><br/><b>Cloud Computing</b><br/>AWS Lambda<br/><br/><b>Storage</b><br/>AWS S3</td>
